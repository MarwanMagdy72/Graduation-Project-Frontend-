...
const YearRange = () => {
  ...
  const [currentData, setCurrentData] = useState(
    dataYear.find((data) => data.year === selectedYear)
  );
  ...
  return (
    <div>
      <Stack direction={"row"} justifyContent={"space-between"}>
        ...
        <Stack>
          <FormControl
            sx={{
              borderRadius: "20px",
              backgroundColor: theme.palette.textColor.bgyearColor,
              border: "none",
              minWidth: 100,
            }}
            size="small"
          >
            ...
            <Select
              ...
              sx={{
                borderRadius: "20px",
                fontWeight: 400,
                color: theme.palette.textColor.textyearColor,
              }}
      ...
      <Stack direction={"column"}>
        ...
        <Stack>
          <YearRangeChart />
          <Box sx={{ position: "relative", top: "-110px", left: "35.5%" }}>
            <Typography sx={{ fontSize: "20px ", color: "#949494" }}>
              {" "}
              Total User
            </Typography>
            <Typography
